...
public class ViewSchedules extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(SchFragment.newInstance("Monday"), "Mon");
        adapter.addFragment(SchFragment.newInstance("Tuesday"), "Tue");
        adapter.addFragment(SchFragment.newInstance("Wednesday"), "Wed");
        adapter.addFragment(SchFragment.newInstance("Thursday"), "Thu");
        adapter.addFragment(SchFragment.newInstance("Friday"), "Fri");
        adapter.addFragment(SchFragment.newInstance("Saturday"), "Sat");
        adapter.addFragment(SchFragment.newInstance("Sunday"), "Sun");
